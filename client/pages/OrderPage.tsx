...
export default function OrderPage() {
  ...
  const handleSendOrder = (e?: React.MouseEvent) => {
    ...
    const whatsappWebUrl = `https://web.whatsapp.com/send?phone=${mockRestaurant.whatsappNumber}&text=${encodedMessage}`;

    // Fallback para wa.me
    const whatsappAppUrl = `https://wa.me/${mockRestaurant.whatsappNumber}?text=${encodedMessage}`;
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <Textarea
                ...
                placeholder="Informe seu endereço (opcional)"
            ...
            <div>
              ...
              <select
                ...
                className="w-full h-12 px-4 rounded-lg border border-gray-300 focus:border-orange-500 focus:ring-orange-500"
              >
        ...
        <div className="bg-white rounded-2xl shadow-md p-6 mb-6">
          <div className="space-y-3">
            ...
            <div className="flex justify-between text-gray-600 text-sm">
              <span>Impostos e taxas estimados</span>
              <span>R$ {(totalPrice * 0.08).toFixed(2)}</span>
            </div>
            <div className="border-t border-gray-200 pt-3 flex justify-between text-lg font-bold text-gray-900">
              <span>Total</span>
              <span>R$ {(totalPrice * 1.08).toFixed(2)}</span>
            </div>
          </div>
        </div>
